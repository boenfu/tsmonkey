...
// @ts-expect-error ts(2589)
export type StringToNumber<TString extends string> = TString extends `${infer TPrefix}${infer TRest}` ? Plus<Multiply<NumberMap[TPrefix], Pow<10, StringLength<TRest>>>, StringToNumber<TRest>> : 0
